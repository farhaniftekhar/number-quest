...
export class RationalRealm {
    constructor() {
        ...
        this.title = "Rational Realm: Finite vs Endless";
        this.world = "rationality";
        this.description = "See how rational numbers land neatly while √2 and π keep stretching. No beads can finish them.";
        this.showSqrt = false;
        this.showPi = false;
        this.showRepeating = false;
        this.complete = false;
        this.line = new NumberLine(80, 260, 800);
        this.fractionBar = new FractionBar(120, 140, 240, 40);
    }
    onEnter(context) {
        this.ctx = context;
        this.complete = false;
        ...
        context.ui.setFeedback("Rational numbers can be completed with beads or bars. Irrational numbers stretch forever.");
    }
    update() {
    ...
    render(ctx) {
        ...
        ctx.fillText("Beads can model 1/3 or 3/4 because they finish. They cannot finish √2 or π.", 80, 320);
        ctx.restore();
    }
    isComplete() {
...
//# sourceMappingURL=rationalRealm.js.map